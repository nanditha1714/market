...
export const FALLBACK_DATA = {
  ...
  detailedReport: {
    marketGrowth: 'Based on the historical and projected data, the market has demonstrated consistent upward momentum, expanding from early baselines to a projected size of $5.2B. This steady growth is driven by accelerated digital transformation and increasing adoption rates across target demographics. Organizations in this space must capitalize on this trajectory by scaling operations to meet growing demand.',
    segmentation: 'The market is divided into distinct customer segments: Enterprise accounts for the largest share at 45%, followed closely by SMBs at 35%, and Startups at 20%. The high concentration in Enterprise suggests significant contract value opportunities, while the SMB and Startup segments represent high-velocity growth areas that require lower touch-points and streamlined onboarding.',
    geography: 'Geographical breakdown indicates that North America leads market share at 40%, with Europe representing 30%, Asia at 20%, and other regions comprising the remaining 10%. Expansion efforts should prioritize strengthening presence in established North American and European markets before executing localized GTM strategies in fast-growing Asian hubs.',
    competition: 'The competitive landscape features established players, with Competitor A leading at 35% market share, followed by Competitor B at 25%, and Competitor C at 18%. Your company currently commands a 12% share. According to the positioning matrix, your core differentiators lie in product innovation and customer support, whereas competitors leverage brand legacy and aggressive pricing.',
    pricing: 'A comparative analysis of pricing structures shows a diverse range of models. While Competitor A occupies the premium tier, Competitor B captures budget-conscious users. Your product is positioned as a competitive value option, balancing advanced features with an accessible price point to maximize customer acquisition.',
    risks: 'The primary risks facing the company include intense competition from legacy vendors, high customer acquisition costs (CAC), and potential talent shortages in key engineering and product roles. Mitigating these challenges requires investing heavily in proprietary product features to raise switching costs and optimizing self-service customer pipelines.'
  }
};
